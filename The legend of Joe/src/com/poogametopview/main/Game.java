...
import com.poogametopview.entities.ShotPistol;
...
public class Game extends Canvas implements Runnable, KeyListener{
	...
	public static List<ShotPistol> pistolBullets;
	...
	public Game() {
		...
		pistolBullets = new ArrayList<ShotPistol>();
		spritesheet = new Spritesheet("/spritesheet.png");
		
		player = new Player(0, 0, 16, 16, spritesheet.getSprite(16 * 0, 16 * 7, 16, 16));
		entities.add(player);
	...
	public void initFrame() {
		...
		frame = new JFrame("The legend of Joe");
		frame.add(this);
	...
	public void tick() {
		...
		if(gameState == "NORMAL") {
			...
			for(int i = 0; i < pistolBullets.size(); i++) 
				pistolBullets.get(i).tick();
			
			if(enemies.size() == 0 && enemies2.size() == 0 && boss.size() == 0) {
				//PASSOU DE FASE
				curLevel++;
	...
	public void keyReleased(KeyEvent e) {
		if(e.getKeyCode() == KeyEvent.VK_RIGHT || e.getKeyCode() == KeyEvent.VK_D) {
			//CESSA O MOVIMENTO PARA DIREITA
			player.right = false;
		}else if(e.getKeyCode() == KeyEvent.VK_LEFT || e.getKeyCode() == KeyEvent.VK_A) {
			//CESSA O MOVIMENTO PARA ESQUERDA
			player.left = false;
		}

		if(e.getKeyCode() == KeyEvent.VK_UP || e.getKeyCode() == KeyEvent.VK_W) {
			//CESSA O MOVIMENTO PARA CIMA
			player.up = false;
		}else if(e.getKeyCode() == KeyEvent.VK_DOWN || e.getKeyCode() == KeyEvent.VK_S) {
			//CESSA O MOVIMENTO PARA BAIXO
			player.down = false;
		}
	}
